...
namespace ns
{
    struct PlayWindowSite
    {
        int x=0;
        int y=0;
    };
    VIPLEXCOMMON_EXPORT void to_json(json& j, const PlayWindowSite& data);
    VIPLEXCOMMON_EXPORT void from_json(const json& j, PlayWindowSite& data);

    struct SetPlayWindowSite
    {
        string sn;
        ns::PlayWindowSite playWindowSite;
    };
    VIPLEXCOMMON_EXPORT void to_json(json& j, const SetPlayWindowSite& data);
    VIPLEXCOMMON_EXPORT void from_json(const json& j, SetPlayWindowSite& data);

    struct TimeZoneInfo
    {
        int64_t utcTimeMillis=0;
        string timeZone;
        string gmt;
        string isTimeOffsetEnable;
        string beginTime;
        string endTime;
        int64_t timeOffsetValue=0;
    };
...
namespace ns
{
    ...
    struct Regulation
    {
        ...
        bool brightnessEnable = true;
        bool volumeEnable = true;
        bool environmentalMonitoring = true;
    };
...
namespace ns
{
    ...
    struct OnlinePackage
    {
        ...
        string identifier;
        string type;
        bool startupAfterInstalled = true;
        int64_t size=0;
    };
    ...
    struct UpdatePackageUploadProgress
    {
        ...
        qint64 bytesSent=0;                  //已传输的字节
        qint64 bytesTotal=0;                 //文件总字节数
    };
...
namespace ns
{
    ...
    {
        bool isSupportCompleteCron = true;
    };
...
namespace ns
{
    ...
    {
        long long utcTimeMillis=0;
        string timeZone;
        string gmt;
        bool isTimeOffsetEnable=true;
        string beginTime;
        string endTime;
...
namespace ns
{
    ...
    VIPLEXCOMMON_EXPORT void to_json(json& j, const FileNameSn& result);
    VIPLEXCOMMON_EXPORT void from_json(const json& j, FileNameSn& result);
    ...
    struct RecvCardValue
    {
        std::string sn;
        int value;
    };
    VIPLEXCOMMON_EXPORT void to_json(json& j, const RecvCardValue& result);
    VIPLEXCOMMON_EXPORT void from_json(const json& j, RecvCardValue& result);

    struct Value
    {
        int value;
    };
    VIPLEXCOMMON_EXPORT void to_json(json& j, const Value& result);
    VIPLEXCOMMON_EXPORT void from_json(const json& j, Value& result);

    struct ValueStr
    {
        std::string value;
    };
    VIPLEXCOMMON_EXPORT void to_json(json& j, const ValueStr& result);
    VIPLEXCOMMON_EXPORT void from_json(const json& j, ValueStr& result);
}
...
namespace ns
{
    ...
    struct StartTransferProgram
    {
        ...
        bool startPlayAfterTransferred = true;
        bool insertPlay = true;
    ...
    struct StartTransferProgramUseOSS
    {
        string sn;
        string programName;
        string programPath = "";
        string programFileMd5;
        string deviceIdentifier;
        bool startPlayAfterTransferred = true;
        bool insertPlay = true;
        int64_t programFileSize;
        int64_t mediaSize;
    };
    VIPLEXCOMMON_EXPORT void to_json(json& j, const StartTransferProgramUseOSS& data);
    VIPLEXCOMMON_EXPORT void from_json(const json& j, StartTransferProgramUseOSS& data);


    
    struct updateTemplateInterProgramData
    {
        string name;
        string path;
        int backVolume = 0;
    };
    VIPLEXCOMMON_EXPORT void to_json(json& j, const updateTemplateInterProgramData& data);
    VIPLEXCOMMON_EXPORT void from_json(const json& j, updateTemplateInterProgramData& data);

    struct updateTemplateInterData
    {
        string sn;
        ns::updateTemplateInterProgramData data;
    };
    VIPLEXCOMMON_EXPORT void to_json(json& j, const updateTemplateInterData& data);
    VIPLEXCOMMON_EXPORT void from_json(const json& j, updateTemplateInterData& data);
    ...
    struct StartTransferFiterProgram
    {
        string sn;
        string iconPath;
        string iconName;
    ...
    VIPLEXCOMMON_EXPORT void to_json(json& j, const StartTransferFiterProgram& data);
    VIPLEXCOMMON_EXPORT void from_json(const json& j, StartTransferFiterProgram& data);

    struct StartTransferInterProgramLocal
    {
        string sn;
        string iconPath;
        string iconName;
        ...
        string spotsType;
        long delayTime=0;
        string normalProgramStatus;
        bool isSupportMd5Checkout = false;
    };
    VIPLEXCOMMON_EXPORT void to_json(json& j, const StartTransferInterProgramLocal& data);
    VIPLEXCOMMON_EXPORT void from_json(const json& j, StartTransferInterProgramLocal& data);
    ...
    VIPLEXCOMMON_EXPORT void to_json(json& j, const ConfirmedInfosInter& data);
    VIPLEXCOMMON_EXPORT void from_json(const json& j, ConfirmedInfosInter& data);

    struct EndTransferInterProgramInfo
    {
        Source source;
        string spotsType;
        string normalProgramStatus = "NORMAL";
        long playTime=0;
        long delayTime=0;
        ConfirmedInfosInter confirmedInfos;
    };
    VIPLEXCOMMON_EXPORT void to_json(json& j, const EndTransferInterProgramInfo& data);
    VIPLEXCOMMON_EXPORT void from_json(const json& j, EndTransferInterProgramInfo& data);

    struct EndTransferInterProgram
    {
        string sn;
        EndTransferInterProgramInfo endTransferInterProgramInfo;
    };
    VIPLEXCOMMON_EXPORT void to_json(json& j, const EndTransferInterProgram& data);
    VIPLEXCOMMON_EXPORT void from_json(const json& j, EndTransferInterProgram& data);
...
namespace ns {
    struct SearchResponseData
    {
        ...
        long long screenLogFileSize=0;
        long long screenLogTime=0;
        int64_t connectId;
    };
...
namespace ns
{
    struct APNInfoData
    {
        ...
        bool isUserDefined=true;		//	是否用户自定义6
        bool isUsed=true;			//	是否正在使用
    };
...
namespace ns
{
    ...
    VIPLEXCOMMON_EXPORT void to_json(json& j, const ServiceInfo& data);
    VIPLEXCOMMON_EXPORT void from_json(const json& j, ServiceInfo& data);

    struct ServiceInfoList
    {
        vector<ServiceInfo> serviceInfos;
    };
    VIPLEXCOMMON_EXPORT void to_json(json& j, const ServiceInfoList& data);
    VIPLEXCOMMON_EXPORT void from_json(const json& j, ServiceInfoList& data);
...
namespace ns
{
    ...
    struct SensorDataDetail
    {
        ...
        bool isUpgradeSensorProgram = true;
    };
...
namespace ns
{
    ...
    struct ReceiveCardRegionInfoData
    {
        ...
        int width = 0;
        int height = 0;
        int rowIndexInScreen = 0;
        int colIndexInScreen = 0;
    };
...
namespace ns
{
    ...
    struct InterProgramResult 
    {
        int code=0;
        string data;
    };
    VIPLEXCOMMON_EXPORT void to_json(json& j, const InterProgramResult& data);
    VIPLEXCOMMON_EXPORT void from_json(const json& j, InterProgramResult& data);


    struct GetScreenShotData
    {
        string path;
        int type;
        string sn;
    };
    VIPLEXCOMMON_EXPORT void to_json(json& j, const GetScreenShotData& data);
    VIPLEXCOMMON_EXPORT void from_json(const json& j, GetScreenShotData& data);


    struct SignalType
    {
        int type;
        ns::TemplateSize screenshot;
    };
    VIPLEXCOMMON_EXPORT void to_json(json& j, const SignalType& data);
    VIPLEXCOMMON_EXPORT void from_json(const json& j, SignalType& data);

    struct GetScreenShotResponseData
    {
        string path;
        long long totalSize;
        long long offset;
    ...
    VIPLEXCOMMON_EXPORT void to_json(json& j, const GetScreenShotResponseData& data);
    VIPLEXCOMMON_EXPORT void from_json(const json& j, GetScreenShotResponseData& data);



    

    struct GetScreenShotFileData
    {
        string path;
        long offset;
        long length;
    };
    VIPLEXCOMMON_EXPORT void to_json(json& j, const GetScreenShotFileData& data);
    VIPLEXCOMMON_EXPORT void from_json(const json& j, GetScreenShotFileData& data);



    
    struct GetFileFromTerminalData
    {
        string sn;
        string identifier;
        string path;
    ...
    VIPLEXCOMMON_EXPORT void to_json(json& j, const GetFileFromTerminalData& data);
    VIPLEXCOMMON_EXPORT void from_json(const json& j, GetFileFromTerminalData& data);
    ...
    VIPLEXCOMMON_EXPORT void to_json(json& j, const TerminalInfo& data);
    VIPLEXCOMMON_EXPORT void from_json(const json& j, TerminalInfo& data);

    struct TerminalInfos
    {
        std::vector<ns::TerminalInfo> programInfos;
    };
    VIPLEXCOMMON_EXPORT void to_json(json& j, const TerminalInfos& data);
    VIPLEXCOMMON_EXPORT void from_json(const json& j, TerminalInfos& data);
    ...
    {
        string sn;
        ns::DeleteProgramListDatas data;
    };
    VIPLEXCOMMON_EXPORT void to_json(json& j, const ProgramRename& data);
    VIPLEXCOMMON_EXPORT void from_json(const json& j, ProgramRename& data);


    struct VedioFastForward
    {
        string sn;
        int type;
        float percent=0;
    ...
    VIPLEXCOMMON_EXPORT void to_json(json& j, const VedioFastForward& data);
    VIPLEXCOMMON_EXPORT void from_json(const json& j, VedioFastForward& data);

    struct VedioFastForwardForPercent
    {
        float percent;
    };
    VIPLEXCOMMON_EXPORT void to_json(json& j, const VedioFastForwardForPercent& data);
    VIPLEXCOMMON_EXPORT void from_json(const json& j, VedioFastForwardForPercent& data);
    
    struct VedioFastForwardForTime
    {
        long time = 0;
    };
    VIPLEXCOMMON_EXPORT void to_json(json& j, const VedioFastForwardForTime& data);
    VIPLEXCOMMON_EXPORT void from_json(const json& j, VedioFastForwardForTime& data);

    struct pptProgramPageTurnResquestData
    {
        int type=1;
    };
    VIPLEXCOMMON_EXPORT void to_json(json& j, const pptProgramPageTurnResquestData& data);
    VIPLEXCOMMON_EXPORT void from_json(const json& j, pptProgramPageTurnResquestData& data);
    ...
    VIPLEXCOMMON_EXPORT void to_json(json& j, const ProgramErrorInfo& data);
    VIPLEXCOMMON_EXPORT void from_json(const json& j, ProgramErrorInfo& data);

    struct PublicNetProgramErrorInfo
    {
        int returnCode = 0;
        string errorDiscription;
    };
    VIPLEXCOMMON_EXPORT void to_json(json& j, const PublicNetProgramErrorInfo& data);
    VIPLEXCOMMON_EXPORT void from_json(const json& j, PublicNetProgramErrorInfo& data);
