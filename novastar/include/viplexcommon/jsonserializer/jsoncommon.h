...
namespace ns
{
    ...
    struct LayoutStyles
    {
        int type=0;//布局样式类型，0：间距 1:自定义标签，2：数值，3：单位，4：数值+单位
    ...
    struct RegularContents
    {
        ...
        int type=0;//对应不同单位的换算类型
        int compension=0;//补偿值
...
namespace ns {
    ...
    struct  WidgetForJson
    {
        ...
        StreamMetadata stramMetaData;
        string functionStorage;
        bool isSupportSpecialEffects=true;
...
namespace ns
{
    ...
    struct UpdateOSUseOSS
    {
        string sn;
        std::vector<UpdateTask> tasks;
    };
    VIPLEXCOMMON_EXPORT void to_json(json& j, const UpdateOSUseOSS& task);
    VIPLEXCOMMON_EXPORT void from_json(const json& j, UpdateOSUseOSS& task);
...
namespace ns
{
    ...
    struct SNLoginReplyData
    {
        string sn;
        LoginReplyData data;
    };
    VIPLEXCOMMON_EXPORT void to_json(json& j, const SNLoginReplyData& data);
    VIPLEXCOMMON_EXPORT void from_json(const json& j, SNLoginReplyData& data);
...
#pragma region Region 更新节目
    ...
    struct UpdateFiterProgramData
    {
        string identifier;
        long playTime=0;
        std::string normalProgramStatus = "NORMAL";
        UpdateProgramPlanData plan;
        UpdateProgramThumbnailData thumbnail;
    };
    VIPLEXCOMMON_EXPORT void to_json(json& j, const UpdateFiterProgramData& data);
    VIPLEXCOMMON_EXPORT void from_json(const json& j, UpdateFiterProgramData& data);

    struct UpdateTemplateFiterProgramData
    {
        string identifier;
        long playTime = 0;
        std::string normalProgramStatus = "NORMAL";
    ...
    VIPLEXCOMMON_EXPORT void to_json(json& j, const UpdateTemplateFiterProgramData& data);
    VIPLEXCOMMON_EXPORT void from_json(const json& j, UpdateTemplateFiterProgramData& data);
    ...
    struct UpdateFiterProgramDataTaskArray : TaskArrayFor0x99
    {
        UpdateFiterProgramData data;
    };
    VIPLEXCOMMON_EXPORT void to_json(json& j, const UpdateFiterProgramDataTaskArray& data);
    VIPLEXCOMMON_EXPORT void from_json(const json& j, UpdateFiterProgramDataTaskArray& data);

    struct UpdateTemplateFiterProgramDataTaskArray : TaskArrayFor0x99
    {
        UpdateTemplateFiterProgramData data;
    };
    VIPLEXCOMMON_EXPORT void to_json(json& j, const UpdateTemplateFiterProgramDataTaskArray& data);
    VIPLEXCOMMON_EXPORT void from_json(const json& j, UpdateTemplateFiterProgramDataTaskArray& data);
    ...
    struct UpdateFiterProgramRequestData
    {
        Source source;
        vector<UpdateFiterProgramDataTaskArray> taskArray;
    };
    VIPLEXCOMMON_EXPORT void to_json(json& j, const UpdateFiterProgramRequestData& data);
    VIPLEXCOMMON_EXPORT void from_json(const json& j, UpdateFiterProgramRequestData& data);

    struct UpdateTemplateFiterProgramRequestData
    {
        Source source;
        vector<UpdateTemplateFiterProgramDataTaskArray> taskArray;
    };
    VIPLEXCOMMON_EXPORT void to_json(json& j, const UpdateTemplateFiterProgramRequestData& data);
    VIPLEXCOMMON_EXPORT void from_json(const json& j, UpdateTemplateFiterProgramRequestData& data);
    ...
    struct CommonCallbackData 
    {
        string data;
    };
    VIPLEXCOMMON_EXPORT void to_json(json& j, const CommonCallbackData& data);
    VIPLEXCOMMON_EXPORT void from_json(const json& j, CommonCallbackData& data);
