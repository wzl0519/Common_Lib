...
#pragma region ScreenManager
   VIPLEX_EXPORT void setPlayWindowSite(const char* data, ExportViplexCallback callback);
   VIPLEX_EXPORT void getPlayWindowSite(const char* data, ExportViplexCallback callback);
   /**
    * @brief 回读时间
    * 获取卡时间
    * @param const char * data 格式如：
