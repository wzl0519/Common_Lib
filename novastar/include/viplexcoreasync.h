...
class VIPLEX_EXPORT ViplexCoreAsync final
{
public:
    ...
    static void nvInitPublicNetConfigWithoutFSAsync(const char* data, ViplexCallback connectCallback, ViplexCallback disconnectCallback);
    ...
    static void nvGetInterProgramInfoAsync(const char* data, ViplexCallback callback);
    static void nvStopInterProgramAsync(const char* data, ViplexCallback callback);
    ...
    static void nvPublicModuleUpdateOSUseOSSAsync(const char* data, ViplexCallback callback);
    ...
    static void nvSendScreenScrAsync(const char* data, ViplexCallback callback);
    ...
    static void nvSetPlayWindowSiteAsync(const char* data, ViplexCallback callback);
    static void nvGetPlayWindowSiteAsync(const char* data, ViplexCallback callback);
    ...
    static void nvGetScreenShotAsync(const char* data, ViplexCallback callback);
    ...
    static void nvTransferMultiplePageProgramAsync(const char* data, ViplexCallback callback);
    static void nvStartTransferInterProgramAsync(const char* data, ViplexCallback callback);
    static void nvStopUpdateFiterProgramAsync(const char* data, ViplexCallback callback);
    static void nvCreateInterProgramAsync(const char* data, ViplexCallback callback);   
    static void nvMakeProgramToZipAsync(const char* data, ViplexCallback callback);

    static void nvStartTransferProgramUseOSSAsync(const char* data, ViplexCallback callback);
    static void nvGetFileFromTerminalAsync(const char* data, ViplexCallback callback);
    static void nvPPTProgramPageTurnAsync(const char* data, ViplexCallback callback);
    static void nvProgramRenameAsync(const char* data, ViplexCallback callback);
    static void nvVedioFastForwardAsync(const char* data, ViplexCallback callback);
    
    static void nvGetProgramPageDurationAsync(const char* data, ViplexCallback callback);
    static void nvSendTemplateInterProgramAsync(const char* data, ViplexCallback callback);
    static void nvUpdateTemplateInterProgramAsync(const char* data, ViplexCallback callback);
    ...
    static void nvDownloadPlayListingLogNetAsync(const char* data, ViplexCallback callback);
    ...
    //playService
    static void nvGetTerminalServiceAsync(const char* data, ViplexCallback callback);
    static void nvStartServiceAsync(const char* data, ViplexCallback callback);
    static void nvStopServiceAsync(const char* data, ViplexCallback callback);
	
	//运行app
    static void nvRunAppAsync(const char* data, ViplexCallback callback);
...
private:
    ...
    static std::string insertSn1(const char* data, std::string sn);
