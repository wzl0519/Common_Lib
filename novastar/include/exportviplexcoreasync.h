...
#pragma region publicnet 公网配置
    ...
    */
	...
	VIPLEX_EXPORT void nvInitPublicNetConfigWithoutFSAsync(const char* data, ExportViplexCallback connectCallback, ExportViplexCallback disconnectCallback);
...
#pragma region ScreenConfiguration
   ...
   */
    ...
    VIPLEX_EXPORT void nvSendScreenScrAsync(const char* data, ExportViplexCallback  callback);
...
#pragma region ScreenManager
    VIPLEX_EXPORT void nvSetPlayWindowSiteAsync(const char* data, ExportViplexCallback  callback);
    VIPLEX_EXPORT void nvGetPlayWindowSiteAsync(const char* data, ExportViplexCallback  callback);
	/**
	  * showdoc
...
#pragma region EditProgram
    ...
    */
	...
	VIPLEX_EXPORT void nvCreateInterProgramAsync(const char* data, ExportViplexCallback  callback);
...
*/
    ...
    */
	...
	VIPLEX_EXPORT void nvMakeProgramToZipAsync(const char* data, ExportViplexCallback  callback);
    /**
    * showdoc
    * @catalog 接口示例/节目
    * @title 配置默认系统模板
    ...
    */
	...
	VIPLEX_EXPORT void nvStartTransferProgramUseOSSAsync(const char* data, ExportViplexCallback  callback);
    ...
    */
	...
	VIPLEX_EXPORT void nvSendTemplateInterProgramAsync(const char* data, ExportViplexCallback callback);
	VIPLEX_EXPORT void nvUpdateTemplateInterProgramAsync(const char* data, ExportViplexCallback callback);
...
#pragma endregion	
	...
	VIPLEX_EXPORT void nvStartTransferInterProgramAsync(const char* data, ExportViplexCallback callback);
	VIPLEX_EXPORT void nvGetInterProgramInfoAsync(const char* data, ExportViplexCallback callback);
	VIPLEX_EXPORT void nvStopInterProgramAsync(const char* data, ExportViplexCallback callback);
	VIPLEX_EXPORT void nvStopUpdateFiterProgramAsync(const char* data, ExportViplexCallback callback);
	VIPLEX_EXPORT void nvPublicModuleUpdateOSUseOSSAsync(const char* data, ExportViplexCallback callback);


	VIPLEX_EXPORT void nvGetFileFromTerminalAsync(const char* data, ExportViplexCallback callback);
	VIPLEX_EXPORT void nvPPTProgramPageTurnAsync(const char* data, ExportViplexCallback callback);
	VIPLEX_EXPORT void nvProgramRenameAsync(const char* data, ExportViplexCallback callback);
	VIPLEX_EXPORT void nvVedioFastForwardAsync(const char* data, ExportViplexCallback callback);
	VIPLEX_EXPORT void nvGetProgramPageDurationAsync(const char* data, ExportViplexCallback callback);
