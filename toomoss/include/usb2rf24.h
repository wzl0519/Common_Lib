...
#ifndef __U2B2RF24_H__
#define __U2B2RF24_H__
...
typedef struct{
    ...
    unsigned char RxAddr[6][5];
    bool RxAddrEn[6];
    rf24_pa_dbm_e pa;
    rf24_datarate_e datarate;
    rf24_crclength_e crclength;
    bool auto_ack[6];
    unsigned char retries_delay;
    unsigned char retries_count;
    unsigned char payload_size[6];
    unsigned char addr_width;
    unsigned char channel;
    bool dynamic_payload_length;
}rf24_setting_s;
...
extern "C"
{
  ...
  */
   ...
   */
  bool WINAPI RF24_begin(int dev_handle,int spi_index,unsigned short ce_pin);
   ...
   * @endcode
   */
  void WINAPI RF24_startListening(int dev_handle,int spi_index);
   ...
   * @endcode
   */
  void WINAPI RF24_stopListening(int dev_handle,int spi_index);
   ...
   */
  bool WINAPI RF24_available(int dev_handle,int spi_index,unsigned char* pipe_num);
   ...
   */
  void WINAPI RF24_read(int dev_handle,int spi_index,void* buf, unsigned char len );
   ...
   */
 // bool WINAPI RF24_write(int dev_handle,int spi_index,const void* buf, unsigned char len );
...
s   *
  ...
  void WINAPI RF24_openWritingPipe(int dev_handle,int spi_index,const unsigned char *address);
  ...
  void WINAPI RF24_openReadingPipe(int dev_handle, int spi_index, unsigned char number, const unsigned char *address, bool rx_en);
   ...
   */
  bool WINAPI RF24_rxFifoFull(int dev_handle,int spi_index);
   ...
   * @endcode
   */
  void WINAPI RF24_powerDown(int dev_handle,int spi_index);
   ...
   */
  void WINAPI RF24_powerUp(int dev_handle,int spi_index) ;
  ...
  */
  bool WINAPI RF24_write(int dev_handle,int spi_index, const void* buf, unsigned char len, const bool multicast );
   ...
   * @return True if the payload was delivered successfully false if not
   */
  //bool writeFast(int dev_handle,int spi_index, const void* buf, unsigned char len );
  ...
  */
  bool WINAPI RF24_writeFast(int dev_handle,int spi_index, const void* buf, unsigned char len, const bool multicast );
   ...
   *
   *			radio.writeBlocking(&buf,32,1000000); //Wait up to 1 second to write 1 payload to the buffers
   ...
   */
  bool WINAPI RF24_writeBlocking(int dev_handle,int spi_index, const void* buf, unsigned char len, unsigned int timeout_us );
   ...
   *
   */
   //bool WINAPI RF24_txStandBy(int dev_handle,int spi_index);
   ...
   *
   */
   bool WINAPI RF24_txStandBy(int dev_handle,int spi_index,unsigned int timeout, bool startTx = 0);
   ...
   */
  void WINAPI RF24_writeAckPayload(int dev_handle,int spi_index,unsigned char pipe, const void* buf, unsigned char len);
   ...
   */
  bool WINAPI RF24_isAckPayloadAvailable(int dev_handle,int spi_index);
   ...
   */
  void WINAPI RF24_whatHappened(int dev_handle,int spi_index,bool& tx_ok,bool& tx_fail,bool& rx_ready);
   ...
   * @return True if the payload was delivered successfully false if not
   */
  void WINAPI RF24_startFastWrite(int dev_handle,int spi_index,const void* buf, unsigned char len, const bool multicast, bool startTx = 1 );
   ...
   *
   */
  void WINAPI RF24_startWrite(int dev_handle,int spi_index,const void* buf, unsigned char len, const bool multicast );
   ...
   */
   void WINAPI RF24_reUseTX(int dev_handle,int spi_index);
   ...
   */
  unsigned char WINAPI RF24_flush_tx(int dev_handle,int spi_index);
   ...
   */
  bool WINAPI RF24_testCarrier(int dev_handle,int spi_index);
   ...
   */
  bool WINAPI RF24_testRPD(int dev_handle,int spi_index) ;
...
//  bool isValid() { return ce_pin != 0xff && csn_pin != 0xff; }
   ...
   */
  void WINAPI RF24_closeReadingPipe(int dev_handle,int spi_index, unsigned char pipe ) ;

   /**
   * Enable error detection by un-commenting #define FAILURE_HANDLING in WINAPI RF24_config.h
  ...
  */
  ...
  void WINAPI RF24_setAddressWidth(int dev_handle,int spi_index,unsigned char a_width);
   ...
   */
  void WINAPI RF24_setRetries(int dev_handle,int spi_index,unsigned char delay, unsigned char count);
   ...
   */
  void WINAPI RF24_setChannel(int dev_handle,int spi_index,unsigned char channel);
   ...
   */
  unsigned char WINAPI RF24_getChannel(int dev_handle,int spi_index);
   ...
   */
  void WINAPI RF24_setPayloadSize(int dev_handle,int spi_index,unsigned char size[]);
   ...
   */
  void WINAPI RF24_getPayloadSize(int dev_handle,int spi_index,unsigned char size[]);
   ...
   */
  unsigned char WINAPI RF24_getDynamicPayloadSize(int dev_handle,int spi_index);
   ...
   * enableDynamicPayloads() to enable on all pipes.
   */
  void WINAPI RF24_enableAckPayload(int dev_handle,int spi_index);
   ...
   *
   */
  void WINAPI RF24_enableDynamicPayloads(int dev_handle,int spi_index);
   ...
   *
   */
  void WINAPI RF24_disableDynamicPayloads(int dev_handle,int spi_index);
   ...
   * @endcode
   */
  void WINAPI RF24_setDynamicAck(int dev_handle,int spi_index,bool state);
   ...
   * if its not.
   */
  bool WINAPI RF24_isPVariant(int dev_handle,int spi_index) ;
   ...
   */
  //void WINAPI RF24_setAutoAck(int dev_handle, int spi_index, bool enable);
   ...
   * @param enable Whether to enable (true) or disable (false) auto-acks
   */
  void WINAPI RF24_setAutoAck(int dev_handle,int spi_index, unsigned char pipe, bool enable ) ;

  /**
   * Set Power Amplifier (PA) level to one of four levels:
   * WINAPI RF24_PA_MIN, WINAPI RF24_PA_LOW, WINAPI RF24_PA_HIGH and WINAPI RF24_PA_MAX
   *
   ...
   */
  void WINAPI RF24_setPALevel (int dev_handle,int spi_index, unsigned char level );
   ...
   */
   unsigned char WINAPI RF24_getPALevel( int dev_handle,int spi_index );

  /**
   * Set the transmission data rate
   *
   * @warning setting WINAPI RF24_250KBPS will fail for non-plus units
   *
   * @param speed WINAPI RF24_250KBPS for 250kbs, WINAPI RF24_1MBPS for 1Mbps, or WINAPI RF24_2MBPS for 2Mbps
   * @return true if the change was successful
   */
  bool WINAPI RF24_setDataRate(int dev_handle,int spi_index,rf24_datarate_e speed);

  /**
   * Fetches the transmission data rate
   *
   * @return Returns the hardware's currently configured datarate. The value
   * is one of 250kbs, WINAPI RF24_1MBPS for 1Mbps, or WINAPI RF24_2MBPS, as defined in the
   * rf24_datarate_e enum.
   */
  rf24_datarate_e WINAPI RF24_getDataRate( int dev_handle,int spi_index ) ;

  /**
   * Set the CRC length
   * <br>CRC checking cannot be disabled if auto-ack is enabled
   * @param length WINAPI RF24_CRC_8 for 8-bit or WINAPI RF24_CRC_16 for 16-bit
   */
  void WINAPI RF24_setCRCLength(int dev_handle,int spi_index,rf24_crclength_e length);

  /**
   * Get the CRC length
   * <br>CRC checking cannot be disabled if auto-ack is enabled
   * @return WINAPI RF24_CRC_DISABLED if disabled or WINAPI RF24_CRC_8 for 8-bit or WINAPI RF24_CRC_16 for 16-bit
   */
  rf24_crclength_e WINAPI RF24_getCRCLength(int dev_handle,int spi_index);
   ...
   */
  void WINAPI RF24_disableCRC( int dev_handle,int spi_index ) ;
  ...
  */
  void WINAPI RF24_maskIRQ(int dev_handle,int spi_index,bool tx_ok,bool tx_fail,bool rx_ready);
  ...
  */
   ...
   */
  //void WINAPI RF24_openReadingPipe(int dev_handle,int spi_index,unsigned char number, uint64_t address);
   ...
   * @param address The 40-bit address of the pipe to open.
   */
  //void WINAPI RF24_openWritingPipe(int dev_handle,int spi_index,uint64_t address);
   ...
   */
  //void ce(int dev_handle,bool level);
   ...
   * @return Current value of status register
   */
  //unsigned char read_register_bytes(int dev_handle,int spi_index,unsigned char reg, unsigned char* buf, unsigned char len);
   ...
   */
  //unsigned char read_register(int dev_handle,int spi_index,unsigned char reg);
   ...
   * @return Current value of status register
   */
  //unsigned char write_register_bytes(int dev_handle,int spi_index,unsigned char reg, const unsigned char* buf, unsigned char len);
   ...
   * @return Current value of status register
   */
  //unsigned char write_register(int dev_handle,int spi_index,unsigned char reg, unsigned char value);
   ...
   * @return Current value of status register
   */
  //unsigned char write_payload(int dev_handle,int spi_index,const void* buf, unsigned char len, const unsigned char writeType);
   ...
   * @return Current value of status register
   */
  //unsigned char read_payload(int dev_handle,int spi_index,void* buf, unsigned char len);
   ...
   * @return Current value of status register
   */
  //unsigned char flush_rx(int dev_handle,int spi_index);
   ...
   * @return Current value of status register
   */
  //unsigned char get_status(int dev_handle,int spi_index);
   ...
   * @warning Does nothing if stdout is not defined.  See fdevopen in stdio.h
   */
  //void print_observe_tx(unsigned char value);
   ...
   */
  //void print_byte_register(int dev_handle,int spi_index,const char* name, unsigned char reg, unsigned char qty);
   ...
   * @param qty How many successive registers to print
   */
  //void print_address_register(int dev_handle,int spi_index,const char* name, unsigned char reg, unsigned char qty = 1);
#endif
  /**
   ...
   */
  //void toggle_features(int dev_handle,int spi_index);

  /**
   * Built in spi transfer function to simplify repeating code repeating code
   */

  //unsigned char spiTrans(int dev_handle,int spi_index,unsigned char cmd);
 ...
 * 2. Open WINAPI RF24_config.h in a text editor. Uncomment the line #define SOFTSPI<br>
 * 3. In your sketch, add #include DigitalIO.h
 *
 * @note Note: Pins are listed as follows and can be modified by editing the WINAPI RF24_config.h file<br>
 *
 *     const unsigned char SOFT_SPI_MISO_PIN = 16;
 *     const unsigned char SOFT_SPI_MOSI_PIN = 15;
 *     const unsigned char SOFT_SPI_SCK_PIN = 14;
 *
 * <br>
 ...
 * 2. Edit WINAPI RF24_config.h and uncomment #define SPI_UART
 ...
 * | File               |                   Purpose                                                    |
 * |--------------------|------------------------------------------------------------------------------|
 * | WINAPI RF24_arch_config.h | Basic Arduino/AVR compatibility, includes for remaining support files, etc   |
 * | includes.h         | Linux only. Defines specific platform, include correct WINAPI RF24_arch_config file |
 ...
 * 2. Secondary detection is completed in WINAPI RF24_config.h, causing the include.h file to be included for all supported Linux devices <br>
